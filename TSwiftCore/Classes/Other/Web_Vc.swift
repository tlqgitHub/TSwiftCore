...
//        }
    ...
    override public func setupUI() {
        ...
        self.bridge?.registerHandler("getactivedata", handler:{  data , response in
            ...
            TSwiftCore.sharedInstance.activeData[TSwiftCore.sharedInstance.fieldValue] = TSwiftCore.sharedInstance.activeid
            response(TSwiftCore.sharedInstance.activeData)
        })
...
//        self.loadWebView()
   ...
   public func  loadWebView() {
        if let webUrl = self.webUrl {
            ...
            setHttpCookies(url)
            request.setValue(TSwiftCore.sharedInstance.activeid, forHTTPHeaderField:TSwiftCore.sharedInstance.fieldValue)
    ...
    public func  setHttpCookies(_ url:URL) {
        ...
        props[HTTPCookiePropertyKey.name] = TSwiftCore.sharedInstance.fieldValue
        props[HTTPCookiePropertyKey.value] = TSwiftCore.sharedInstance.activeid
