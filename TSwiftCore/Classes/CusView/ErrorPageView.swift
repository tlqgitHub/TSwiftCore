...
//  TSwiftCore
//
//  Created by Linqiang Tian on 2020/5/18.
//
...
public class ErrorPageView :Base_View{
    ...
    func setupSubviews() {
        ...
        error_ImgV.image = UIImage(named: imgStr, in: TSwiftCore.bundle, compatibleWith: nil)
